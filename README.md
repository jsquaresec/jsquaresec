...
I'm **Joshua Jones**, online as **J2SEC / JSquareSec**.
...
- 🤖 Bots, APIs, backend services, and community tooling
...
SECURITY  // detection • defense • tooling • research
SOFTWARE  // bots • APIs • automation • backend development
```
...
Hands-on Google Cloud credential demonstrating continuous integration and continuous delivery workflows, automated builds, testing, deployment pipelines, and cloud-native software delivery.
...
Ethical hacking credential issued by Cisco and publicly verified through Credly.
...
Intermediate Python programming credential issued by Cisco and publicly verified through Credly.
...
AttackIQ credential focused on applying MITRE ATT&CK v19 to adversary emulation, detection validation, security testing, and defensive improvement.
...
AttackIQ credential covering breach and attack simulation concepts, security control validation, adversary emulation, testing workflows, and continuous defensive improvement.
...
Purple teaming credential covering collaborative red and blue team practices, exercise orientation and planning, security control validation, reporting, remediation, and iterative defensive improvement.
